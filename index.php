...
<header> <!--Es el encabezado-->
  <div class="menu">
   <div class="contenedor" >
      <img class="logo" src="imagenes/logo.PNG" href="#header"> <!--LOGO de la pagina web segun jairo-->
      ...
      <img class="menu-icon" src="imagenes/menu.png" alt=""> <!--imagen de menu para moviles-->
      <nav>
             <ul class="lista-menu"> <!--OJO luego de href="" se esta poniendo los links q pertenece a cada uno del menu siempre llamado el id con # muy importante-->
               <li><a href="#sobre-mi">Sobre Mi</a><!--"a" etiqueta clicleable--></li><!--li es una etiqueta de item de lista-->
...
<footer><!--Footer es pie osea pie de agina.-->
  <div class="contenedor">
    ...
    <div class="redes">
      ...
      <a href="#"> <img src="imagenes/medium.png" alt="imagen de medium"> </a>
    </div>

    <div class="parrafo">
      <p> Desarrollador Web | Jairo Lino . Todos los derechos reservados © 2020</p>
    </div>
...
/*cuando realizas scrol en la ventana aplicame la q sta en el corchete*/
  $(window).scroll(function(){
    ...
    if(scroll > 100){
      ...
      $('.logo').css({"height": "55px"});/*tamaño del logo*/
